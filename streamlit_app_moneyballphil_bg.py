...
# Display logo (local or hosted alternative)
st.image("https://i.imgur.com/QW3g7Zo.png", width=300)  # Updated logo if needed

# Background CSS injection using new image
def add_bg_from_url():
    st.markdown(
         f'''
         <style>
         .stApp {{
             background-image: url("https://i.imgur.com/2vX2pIf.png"); /* New custom background */
...
# Session-based table for storing results
