...
with st.form("player_input"):
    ...
    season_avg = st.number_input("Season AVG", 0.0, 1.0, step=0.0001)
    last7_avg = st.number_input("Last 7 Days AVG", 0.0, 1.0, step=0.0001)
    split_avg = st.number_input("Split AVG (Home/Away)", 0.0, 1.0, step=0.0001)
    hand_avg = st.number_input("AVG vs Handedness", 0.0, 1.0, step=0.0001)
    pitcher_avg = st.number_input("AVG vs Pitcher", 0.0, 1.0, step=0.0001)
